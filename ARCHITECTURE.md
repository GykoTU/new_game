...
### D10 — Hot-loop data are the system's own members
...
Waves scale by **shape, not only by number** --
...
### Day, night and the end of a run (implemented, Stage 3)

**Diagram: [`docs/day-night.svg`](docs/day-night.svg)** — one cycle with the
light curve, what dusk and dawn each do, where the tint applies, and the death
path.
...
### Enemies, waves and the base's zap (implemented, Stage 4)
